...
class ExportOptional {
    ...
    private func returnDefaultIfNilWithOptionalError(name: String, variable: String) -> String {
        ...
        string += "             HGReportHandler.report(\"optional: \(name) returned nil value, using \\(\(variable))\", response: .Error)\n"
        string += "         }\n"
    ...
    private func errorReturnStatement(name: String, variable: String) -> String  {
        var string = ""
        string += "     HGReportHandler.report(\"optional: |\\(self)| is not \(name) mapable, using \\(\(variable))\", response: .Error)\n"
        string += "     return \(variable)\n"
        return string
    }
    ...
    private func errorReturnStatement(name: String, stringValue: String) -> String  {
        var string = ""
        string += "     HGReportHandler.report(\"optional: |\\(self)| is not \(name) mapable, using \(stringValue)\", response: .Error)\n"
    ...
    private func errorReturnArrayStatement(name: String) -> String  {
        var string = ""
        string += "     HGReportHandler.report(\"optional is not [\(name)] mapable, using [] - optional: |\\(self)|\", response: .Error)\n"
        string += "     return []\n"
        return string
    }
